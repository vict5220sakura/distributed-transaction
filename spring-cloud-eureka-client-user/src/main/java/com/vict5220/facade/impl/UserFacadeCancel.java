 ...
 */
@Slf4j
@Service("userFacadeCancel")
public class UserFacadeCancel implements UserFacade {
	...
	public void createUser(String username, String password) {
		userService.userRegistCancel(username, password);
		log.info("用户创建, cancel, username:{}", username);
	}
